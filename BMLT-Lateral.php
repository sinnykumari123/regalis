  ...
  <!-- End header -->
    ...
    <div class="custom-breadcrumns border-bottom">
      <div class="container">
        ...
        <span class="current">Bachelor In Medical Laboratory Technology (B.M.L.T)</span>
      </div>
    </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <h2 class="section-title-underline">
                  <span>Bachelor In Medical Laboratory Technology (B.M.L.T)</span>
                </h2>
              </div>
              <div class="col-lg-12">
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="col-lg-5 mr-auto align-self-center order-2 order-lg-1">
                        <h2 class="section-title-underline mb-5">
                            <span>What is the scope of BMLT?</span>
                        </h2>
