            ...
            <div class="row">
              ...
              <div class="col-lg-8">
                <p>At RIGALIS EDUCATION, we transcend horizons!
                  Going beyond the average, putting in that extra mile, extending ourselves to excel and win on all accounts. As one of the finest institution for the higher studies in the field of Management, Information Technology & Media education, RIGALIS EDUCATION has persistently built on its unique strength of imparting high quality education through pedagogic innovations and emphasizing on its twin objective of Influencing Practice and Promoting Value based growth.</p> 
                  <br>
                <p>
                    RIGALIS EDUCATION displays a differentiated approach across the entire academic flow of activities in higher management education. In all our endeavors, we put a great emphasis on ‘Knowledge and Skills’ as well as ‘Indigenous learner-centric pedagogy’. The approach to pedagogy combines fieldwork, case studies, internship, workshops and instrumented feedback with a strong emphasis on concepts and theory. The intent is to encourage intellectual curiosity and open minds to the adventure of ideas.
                </p>
              </div>
            </div>
