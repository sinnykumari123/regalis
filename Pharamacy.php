  ...
  <!-- End header -->
    ...
    <div class="custom-breadcrumns border-bottom">
      <div class="container">
        ...
        <span class="current">Pharamacy Course</span>
      </div>
    </div>
             ...
             <div class="row mb-5">
                ...
                <div class="col-lg-5 ml-auto align-self-center">
                    ...
                    <ol class="ul-check primary list-unstyled">
                        <li><a href="B-Pharamacy.php">Bachelor Of Pharmacy (B.Pharama)</a> </li>
                        <li><a href="D-Pharamacy.php">Diploma of Pharmacy (D.Pharma)</a> </li>
                    </ol>
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            ...
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                <h2>Bachelor Of Pharmacy (B.Pharama)</h2>
                ...
                <p><a href="B-Pharamacy.php" class="btn btn-primary px-4 rounded-0">Learn More</a></p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                <h2>Diploma Of Pharmacy (D.Pharma)</h2>
                ...
                <p><a href="D-Pharamacy.php" class="btn btn-primary px-4 rounded-0">Learn More</a></p>
              </div>
            </div> 
          </div>
        </div>
