  ...
  <!-- End header -->
        ...
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7">
              ...
              <p>Paramedical Lateral Entry Course</p>
            </div>
          </div>
        </div>
      </div> 
    ...
    <div class="custom-breadcrumns border-bottom">
      <div class="container">
        ...
        <span class="current">Paramedical Lateral Entry Course</span>
      </div>
    </div>
             ...
             <div class="row mb-5">
                ...
                <div class="col-lg-5 ml-auto align-self-center">
                    <h2 class="section-title-underline mb-5">
                        <span>Paramedical Lateral Entry Course</span>
                    </h2>
                   

                    <ol class="ul-check primary list-unstyled">
                        <li><a href="BOTT-Lateral.php">B.Sc Operation Theatre Technology (B.O.T.T)</a> </li>
                        <li><a href="BOT-Lateral.php">Bachelor of Occupational Therapy (B.O.T)</a> </li>
                        <li><a href="BRIT-Lateral.php">Bachelor of Radiology & Imaging Technology (B.R.I.T)</a> </li>
                        <li><a href="BMLT-Lateral.php">Bachelor of Medical Laboratory Technology (B.M.L.T)</a></li>
                        <li><a href="BPT-Lateral.php">Bachelor of Physiotherapy (B.P.T)</a> </li>
                    </ol>
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            ...
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                ...
                <p><a href="BOTT-Lateral.php" class="btn btn-primary px-4 rounded-0">Learn More</a></p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                ...
                <p><a href="BOT-Lateral.php" class="btn btn-primary px-4 rounded-0">Learn More</a></p>
              </div>
            </div> 
          </div>
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                ...
                <p><a href="BRIT-Lateral.php" class="btn btn-primary px-4 rounded-0">Learn More</a></p>
              </div>
            </div> 
          </div>
        </div> 
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            ...
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                <h2>Bachelor In Medical Laboratory Technology (B.M.L.T)</h2>
                ...
                <p><a href="BMLT-Lateral.php" class="btn btn-primary px-4 rounded-0">Learn More</a></p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                ...
                <p><a href="BPT-Lateral.php" class="btn btn-primary px-4 rounded-0">Learn More</a></p>
              </div>
            </div> 
          </div>
        </div>
