<?php 
 ...
 if(isset($_POST['submit']))
 {
    ...
    $kt = "UPDATE `course` SET `course_cover`='".$file."',`course_content`='".$about."' WHERE course_id = 1";
         ...
         <div class="row">
             ...
             <div class="col-md-2 col-sm-2">
              <button class="btn btn-primary" id="sidebar-toggle-btn-in">
                <span class="fa fa-briefcase fa-25 pr-2"></span>Admission
              </button>
        ...
        <div class="col-md-11 col-12 m-auto border">
            <form action="#" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group text-dark">
                     ...
                     <br>
                     <label>course</label>
                          <textarea name="aboutEditInput" rows="20" class="form-control">
                            <?php echo $content;?>
                          </textarea>
                  </div>
