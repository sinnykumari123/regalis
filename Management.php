  ...
  <!-- End header -->
    ...
    <div class="custom-breadcrumns border-bottom">
      <div class="container">
        ...
        <span class="current">Management Course</span>
      </div>
    </div>
             ...
             <div class="row mb-5">
                ...
                <div class="col-lg-5 ml-auto align-self-center">
                    ...
                    <ol class="ul-check primary list-unstyled">
                        <li><a href="BBA.php">Bachlor of Business Administration (BBA)</a> </li>
                        <li><a href="MBA.php">Master of Business Administration (MBA)</a> </li>
                        <li><a href="BCOM.php">Bachelor of Commerce (B.COM)</a> </li>
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            ...
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                <h2>Bachlor Of Business Administration (BBA)</h2>
                <p>BBA is an undergraduate Business Management Course. The full form of BBA is "Bachelor of Business Administration." BBA Course is designed to provide a basic understanding of management education and to train the students in communication skills effectively, which inculcate entrepreneurship skills and decision making.</p>
                <p><a href="BBA.php" class="btn btn-primary px-4 rounded-0">Learn More</a></p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                ...
                <p><a href="BCOM.php" class="btn btn-primary px-4 rounded-0">Learn More</a></p>
              </div>
            </div> 
          </div>
        </div> 
...
<!-- Mirrored from technext.github.io/academics/news-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 04 Apr 2021 10:49:21 GMT -->
</html>