  ...
  <!-- End header -->
    ...
    <div class="custom-breadcrumns border-bottom">
      <div class="container">
        ...
        <span class="current">Technology Course</span>
      </div>
    </div>
             ...
             <div class="row mb-5">
                ...
                <div class="col-lg-5 ml-auto align-self-center">
                    <h2 class="section-title-underline mb-5">
                        <span>Technology Course</span>
                    </h2>
                   

                    <ol class="ul-check primary list-unstyled">
                        <li><a href="BCA.php">Bachlor Of Computer Application (BCA)</a> </li>
                        <li><a href="BSCIT.php">Bachelor Of Science In Information Technology (BSC.IT)</a></li>
                    </ol>
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            ...
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                <h2>Bachlor of Computer Application (BCA)</h2>
                ...
                <p><a href="BCA.php" class="btn btn-primary px-4 rounded-0">Learn More</a></p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                <h2>Bachelor Of Science In Information Technology (BSC.IT)</h2>
                <p>The full form of BSc IT is a Bachelor of Science in Information Technology. BSc IT is a bachelor's degree awarded for an undergraduate course in the Information Technology field. Students seeking career opportunities in IT and software can opt for a BSc IT diploma or course.</p>
                <p><a href="BSCIT.php" class="btn btn-primary px-4 rounded-0">Learn More</a></p>
              </div>
            </div> 
          </div>
        </div> 
